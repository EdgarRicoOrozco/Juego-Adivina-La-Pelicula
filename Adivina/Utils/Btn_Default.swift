...
open class Btn_Default: BtnGradient{
    ...
    public convenience init(
        ...
        buttonBackgroundColor: UIColor = ColorManager.mainGreen,
        buttonSecondBackgroundColor: UIColor = ColorManager.mainGreen,
        ...
        showIcon: Bool = true
        //icon: UIImage = UIImage(named: "id_card") ?? UIImage(systemName: "S")
    ) {
        ...
        defaultDisabledTintColor = ColorManager.colorBlack
        ...
        layer.shadowColor = CGColor(red: 255, green: 255, blue: 255, alpha: 100)
    ...
    public func setEnableButton(enable: Bool){
        if enable {
            ...
            setTitleColor(ColorManager.colorWhite, for: .normal)
        }else{
